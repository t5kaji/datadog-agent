...
require (
	github.com/DataDog/datadog-agent/cmd/internal/runcmd v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/DataDog/datadog-agent/comp/core/configsync => ./comp/core/config/configsync
