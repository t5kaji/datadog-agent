			...
			testCases: []samplingTestCase{
				{
					...
					expectStatsd: func(statsdClient *mockStatsd.MockClientInterface) {
						...
						statsdClient.EXPECT().Count(sampler.MetricsProbabilisticSamplerRuleEvaluations, int64(0), nil, gomock.Any()).Times(0)
						statsdClient.EXPECT().Count(sampler.MetricsProbabilisticSamplerRuleMatches, int64(0), nil, gomock.Any()).Times(0)
					},
				},
			},
		},
